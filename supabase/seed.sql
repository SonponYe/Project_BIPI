...
-- enough to exercise aggregate_pulse_for_week() during development.
insert into users (device_id, region, gender_type, language, tier, consent_given)
values ('11111111-1111-1111-1111-111111111111', 'Greater Accra', 'youth', 'tw', 'guest', true)
on conflict do nothing;

insert into responses (device_id, module_id, topic, track, content_format_used, answer_given, is_correct, time_spent_seconds, dropped_off)
values
